function Set-DCNMNetwork             {
  ...
  Process {
    ...
    if ($networkTemplate)               {$OutputObject.networkTemplate          = $networkTemplate}
    if ($networkExtensionTemplate)      {$OutputObject.networkExtensionTemplate = $networkExtensionTemplate}
